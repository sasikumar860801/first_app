...
class _NewLeadsScreenState extends State<NewLeadsScreen> {
  ...
  // ✅ Bidding time
  String _biddingStart = 'N/A';
  String _biddingEnd = 'N/A';
  ...
  @override
  void dispose() {
    _timer.cancel(); // ✅ Cancel timer when screen closes
    super.dispose();
  }
  ...
  Future<void> _fetchLeads() async {
    ...
    try {
      ...
      if (response['success'] == true) {
        ...
        // ✅ Extract bidding times from first item if exists
        if (data.isNotEmpty) {
          setState(() {
            _biddingStart = data[0]['bidding_start']?.toString() ?? 'N/A';
            _biddingEnd = data[0]['bidding_end']?.toString() ?? 'N/A';
          });
        }
                        ...
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Text(
                                '⏰ Bidding: $_biddingStart - $_biddingEnd',
                                    ...
                                    child: Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          // Device Condition Button with Expand/Collapse
